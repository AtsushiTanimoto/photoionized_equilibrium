...
"""
import numpy
from constants import (h, c, k_B, HI_nu0, HI_a0, HeII_nu0, HeI_nu0, HeII_a0, HeI_a0, Lambda_ff_0)
...
def HI_anu(nu):
    ...
    """
    return numpy.where(nu < HI_nu0, 0.0, HI_a0 * (HI_nu0/nu)**3)
...
def HeII_anu(nu):
    ...
    """
    return numpy.where(nu < HeII_nu0, 0.0, HeII_a0 * (HeII_nu0/ nu)**3)
...
def HeI_anu(nu):
    ...
    """
    x = HeI_nu0 / nu
    sigma = HeI_a0 * (1.66 * x**2.05 - 0.66 * x**3.05)
    return numpy.where(nu < HeI_nu0, 0.0, sigma)
